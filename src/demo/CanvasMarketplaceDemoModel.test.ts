...
describe('CanvasMarketplaceDemoModel', () => {
  it('uses the existing CanvasApp feature pack marketplace', () => {
    ...
    expect(profileIds).toContain('navigation-viewer')
    expect(profileIds).toContain('markup-editor')
    expect(profileIds).toContain('component-authoring-workbench')
    expect(profileIds).toContain('import-workbench')
    expect(profileIds).toContain('component-editor')
    expect(suiteIds).toContain('view-navigation')
    expect(suiteIds).toContain('command-surfaces')
    expect(suiteIds).toContain('creation-tools')
    expect(suiteIds).toContain('component-runtime-pack')
    expect(suiteIds).toContain('media-assets')
    expect(suiteIds).toContain('data-import')
