...
export function CanvasWhiteboardSvgCommandCenterComponent({
  item,
}: {
...
export function CanvasWhiteboardSvgTraceMapComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgReviewBoardComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgGateStripComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
