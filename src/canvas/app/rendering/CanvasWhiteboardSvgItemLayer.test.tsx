...
describe('CanvasWhiteboardSvgItemLayer drawing items', () => {
...
describe('CanvasWhiteboardSvgItemLayer external renderers', () => {
...
function renderItemLayer(
  items: CanvasItem[],
  options: Partial<Parameters<typeof CanvasWhiteboardSvgItemLayer>[0]> = {},
) {
  return renderToStaticMarkup(
    <svg>
      <CanvasWhiteboardSvgItemLayer
