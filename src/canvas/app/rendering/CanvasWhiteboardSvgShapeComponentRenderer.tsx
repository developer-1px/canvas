...
import { CanvasWhiteboardSvgText } from './CanvasWhiteboardSvgComponentText'

export function CanvasWhiteboardSvgConnectorComponent({
  item,
}: {
...
export function CanvasWhiteboardSvgVoteComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
