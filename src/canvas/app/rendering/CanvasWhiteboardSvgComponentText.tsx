...
type CanvasWhiteboardSvgComponentTextProps = {
  compact?: boolean
  item: CanvasComponentItem
}

type CanvasWhiteboardSvgTextProps = {
  strong?: boolean
  text: string
  x: number
  y: number
...
export function CanvasWhiteboardSvgComponentHeader({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgSectionText({
  item,
}: {
  item: CanvasComponentItem
}) {
  const style = getCanvasWhiteboardSvgComponentTextStyle(item)
...
export function CanvasWhiteboardSvgComponentText({
  compact,
  item,
}: CanvasWhiteboardSvgComponentTextProps) {
  const style = getCanvasWhiteboardSvgComponentTextStyle(item)
...
export function CanvasWhiteboardSvgStickyText({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgText({
  strong,
  text,
  x,
  y,
}: CanvasWhiteboardSvgTextProps) {
  return (
    <text
      x={x}
      y={y}
...
function getCanvasWhiteboardSvgComponentTextStyle(
  item: CanvasComponentItem,
