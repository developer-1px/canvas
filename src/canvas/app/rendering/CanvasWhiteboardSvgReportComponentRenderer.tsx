...
import { CanvasWhiteboardSvgComponentHeader } from './CanvasWhiteboardSvgComponentText'
import {
...
} from './CanvasWhiteboardSvgReportComponentModel'

export function CanvasWhiteboardSvgScorecardComponent({
  item,
}: {
...
export function CanvasWhiteboardSvgTimelineComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgQueueComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
...
export function CanvasWhiteboardSvgEvidenceComponent({
  item,
}: {
  item: CanvasComponentItem
}) {
