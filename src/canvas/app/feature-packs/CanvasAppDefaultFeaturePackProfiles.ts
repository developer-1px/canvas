...
export const CANVAS_APP_NAVIGATION_VIEWER_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
...
export const CANVAS_APP_MARKUP_EDITOR_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'markup-editor',
    installedSuiteIds: [
      CANVAS_VIEW_NAVIGATION_SUITE_ID,
...
export const CANVAS_APP_COMPONENT_RUNTIME_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'component-runtime-workbench',
    installedSuiteIds: [
      CANVAS_COMPONENT_RUNTIME_SUITE_ID,
    ],
...
export const CANVAS_APP_COMPONENT_AUTHORING_WORKBENCH_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'component-authoring-workbench',
    installedSuiteIds: [
      CANVAS_COMPONENT_RUNTIME_SUITE_ID,
      CANVAS_COMPONENT_EDITING_SUITE_ID,
    ],
    label: 'Component authoring workbench',
    suiteManifests: DEFAULT_CANVAS_APP_FEATURE_PACK_SUITE_MANIFESTS,
  })

export const CANVAS_APP_IMPORT_WORKBENCH_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'import-workbench',
    installedSuiteIds: [
      CANVAS_MEDIA_ASSETS_SUITE_ID,
...
export const CANVAS_APP_STORY_IMPORT_WORKBENCH_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'story-import-workbench',
    installedSuiteIds: [
      CANVAS_VIEW_NAVIGATION_SUITE_ID,
      CANVAS_STORY_IMPORT_SUITE_ID,
    ],
    label: 'Story import workbench',
    suiteManifests: DEFAULT_CANVAS_APP_FEATURE_PACK_SUITE_MANIFESTS,
  })

export const CANVAS_APP_REVIEW_WORKBENCH_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'review-workbench',
    installedSuiteIds: [
      CANVAS_VIEW_NAVIGATION_SUITE_ID,
...
export const CANVAS_APP_COLLABORATION_WORKBENCH_FEATURE_PACK_PROFILE =
  createCanvasAppFeaturePackProfile({
    id: 'collaboration-workbench',
    installedSuiteIds: [
      CANVAS_COLLABORATION_TOOLS_SUITE_ID,
    ],
    label: 'Collaboration workbench',
    suiteManifests: DEFAULT_CANVAS_APP_FEATURE_PACK_SUITE_MANIFESTS,
  })
