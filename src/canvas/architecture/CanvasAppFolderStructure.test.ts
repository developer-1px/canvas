...
describe('Canvas App folder structure', () => {
  ...
  it('keeps App feature pack install registry at the feature-packs root', () => {
    ...
    expect(rootFeaturePackFiles).toEqual([
      ...
      'src/canvas/app/feature-packs/CanvasAppDefaultFeaturePackProfiles.ts',
      'src/canvas/app/feature-packs/CanvasAppDefaultFeaturePackSuites.ts',
      'src/canvas/app/feature-packs/CanvasAppDefaultFeaturePacks.ts',
      'src/canvas/app/feature-packs/CanvasAppDefaultViewFeaturePacks.ts',
      'src/canvas/app/feature-packs/CanvasAppFeatureFlagSettings.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackActionContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackActionPlans.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackCatalogCalculations.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackContributionSurfaceAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackExtensionBundles.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackInstallPlanConflicts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackInstallPlanContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackInstallPlanDependencies.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackInstallPlanGraph.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackInstallPlanResult.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestConstants.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestFactory.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestFieldAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestIdAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestLifecycleAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestResolution.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackManifestTypes.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceControlContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceControls.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceListingBlockedReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceListingContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceListingFactories.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplacePackageContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplacePackageStates.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplacePackages.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionActionItems.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionControls.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionFacetItems.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionFacets.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSectionSummaries.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSections.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceSelectionControls.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceTargetControlHelpers.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackMarketplaceTargetControls.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionGraphReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionHelpers.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionLifecycleReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionMissingReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionPartialUpdateReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileActionResults.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileAssertions.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileFactory.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileLookup.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfileRuntimeStates.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackProfiles.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackResolvedRuntimeStates.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackRuntimeModel.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackRuntimeStateContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackRuntimeStateFactory.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackRuntimeStatePatch.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackRuntimeStates.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionBlockedReasons.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionContext.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionPartialUpdates.ts',
      ...
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionPlanContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionResults.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackStateTransitionTargets.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackSuiteActionContracts.ts',
      'src/canvas/app/feature-packs/CanvasAppFeaturePackSuiteActionPlans.ts',
