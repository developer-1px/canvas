...
4. `src/canvas/app/workflow` owns App Model modules. Workspace, interaction, text editor, find/replace state, stage rendering, and stage item layer rendering are hidden behind workflow hooks and injected Adapters before props reach the App Shell.
