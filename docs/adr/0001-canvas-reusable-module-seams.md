...
3. `src/canvas/index.ts` is the package public entry for external assembly and Demo code. `src/canvas/app/index.ts` is the App public facade. Demo modules import `src/canvas`, not canvas implementation subpaths.
