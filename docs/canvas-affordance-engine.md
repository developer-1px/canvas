...
| `src/canvas/app/link/CanvasLinkPreviewInspectorPanel.tsx` | 선택한 link preview의 open/source text 변환 action을 App link preview affordance 뒤에 숨긴다 |
