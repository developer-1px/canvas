...
- Canvas Keyboard System Dispatch: Keyboard system intent와 escape cancellation side effect를 system handler bundle 호출로 변환하는 App-owned Module.
