...
- Canvas Pointer Creation Preview: create-rect, drawing creation, arrow, custom creation의 draft overlay와 currentWorld/moved preview를 소유하는 App-owned runtime Module.
- Canvas Pointer Creation Commit: create-rect, drawing creation, arrow, custom creation의 document add commit과 post-create tool 전환 규칙을 소유하는 App-owned runtime Module.
