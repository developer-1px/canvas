...
- Canvas Affordance Catalog: built-in Affordance group과 default feature toggle matrix를 소유하는 Engine-owned what 계약. Canvas Affordance Config의 타입과 검증 기준은 이 catalog에서 유도된다.
...
- Canvas Affordance Catalog는 built-in Affordance 목록과 default toggle matrix를 소유하고, Canvas Affordance Config는 Engine public contract로서 생성/검증/snapshot을 소유한다.
